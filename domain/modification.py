...
def check_content(item: Check):
    ...
    4. 이유를 존댓말로 청소년의 시선에 맞게 reasons에 리스트로 표현해줘
    5. 대안을 존댓말로 advices에 리스트로 표현해줘 이 때 찾은 문장이 본론과 무관하다면 "(삭제)"라고 표현해줘
    6. json 형식으로 출력해줘
    '''
    ...
    pre_output1 = '''
    {
        ...
        "reasons": ["본론 부분이 주제와 무관하게 흘러가고 있습니다. 또한, 존댓말과 반말이 혼용되어 사용되었습니다."],
        "advices": ["(삭제)"]
    }
    '''
