...
def check_content(item: Check):
    ...
    3.입력값에서 아래의 규칙에 해당되는 부분을 3개만 찾아줘
        1) 반말과 존댓말이 모두 사용되었다
        2) 문장의 연결 접속사가 어색하다
    ...
    pre_output1 = '''
    {
        ...
        "advices": ["글의 흐름을 위해서 이 부분은 삭제하는 것은 어떤가요?",
                    "글의 흐름을 위해서 이 부분은 삭제하는 것은 어떤가요?",
                    "글의 흐름을 위해서 이 부분은 삭제하는 것은 어떤가요?"]
    }
    '''
    ...
    pre_output2 = '''
    {
    "mistakes": ["대체육은 고기가 아니다.", "아 배고프다.", "콩고기는 콩으로 만들어져있기때문에 나는 자주먹는다.", "영양성분자체가 고기와 완전히 다르다."],
    "reasons": ["반말과 존댓말이 혼용되어 사용되었습니다.",
                "글의 흐름에 맞지 않는 내용입니다.",
                "흐름에 맞지 않는 단어를 사용하였습니다."],
    "advices": ["글의 흐름에 맞게 반말이나 존댓말을 통일해서 사용해주세요.",
                "글의 흐름에 맞는 내용으로 수정해주세요.",
                "글의 흐름에 맞는 단어를 사용해주세요."]
    }
    '''
    ...
    pre_output3='''
    {
    "mistakes": ["신뢰할 수 있는 정보와 가짜 정보를 구별하기 어려워졌누.", "사실 확인ㅇ을 하는 능력을 키워야 한다."],
    "reasons": ["존댓말과 반말이 혼용되어 사용되었습니다.", "흐름에 맞지 않는 단어를 사용하였습니다."],
    "advices": ["글의 흐름에 맞게 반말이나 존댓말을 통일해서 사용해주세요.", "글의 흐름에 맞는 단어를 사용해주세요."]
    }
    '''
